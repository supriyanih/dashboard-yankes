<template>
    <div class="row">
        <div class="col-lg-12">
            <b-card header="Edit Jumlah FasKes" header-tag="h4" class="bg-success-card">
                <div class="row">
                    <div class="col-lg-7 col-12 mb-3">
                        <vue-form class="form-horizontal form-validation" :state="formstate" @submit.prevent="onSubmit">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <validate tag="div">
                                        <label for="count">Jumlah FasKes</label>
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              .then(response => {
                ...
                },window.location = '#/faskes')
              .catch((error) => miniToastr.error(error, "Error"));
            }
        },
        form_reset() {
            var id = this.$route.params.id;
            axios.get("/api/faskes/"+id+"/edit").then(response => {
                    this.model = {
